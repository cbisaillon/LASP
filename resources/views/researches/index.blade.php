...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
                <div class="research">
                    <div class="research-title d-flex">
                        <h2>Finding better learning algorithms for self-driving cars</h2>
                        <copy-to-clip-board-button title="Reference" to-copy="J. Rezgui, C. Bisaillon and L. Oest O’Leary, &quot;Finding better learning algorithms for self-driving cars&quot; , accepted in IEEE ISNCC 2019 18-21 June, Turkey."></copy-to-clip-board-button>
                    </div>
        ...
        <div class="col-md-6 col-xs-12">
                <div class="research">
                    <div class="research-title d-flex">
                        <h2>Training Genetic Neural Networks Algorithms for Autonomous Cars with the LAOP Platform</h2>
                        <copy-to-clip-board-button title="Reference" to-copy="'J. Rezgui, L. Oest O’Leary, C. Bisaillon and L. Chaari, &quot;Training Genetic Neural Networks Algorithms for Autonomous Cars with the LAOP Platform&quot; , accepted in IEEE IWCMC 2019 Tangier, Morocco.'"></copy-to-clip-board-button>
                    </div>
                    <div class="research-content">
                        <div class="research-authors">
                            <p class="text-2">{{__('Authors')}}</p>
